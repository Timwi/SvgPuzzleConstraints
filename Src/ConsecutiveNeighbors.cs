...
{
    [SvgConstraintInfo("Consecutive neighbors")]
    public class ConsecutiveNeighbors : SvgNeighborConstraint
    {
        ...
        public static IList<SvgConstraint> Generate(int[] sudoku) => generate(sudoku, myVerify, (cell1, cell2) => new ConsecutiveNeighbors(cell1, cell2));
    }
}
