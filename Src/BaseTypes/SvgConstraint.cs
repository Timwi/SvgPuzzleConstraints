...
{
    public abstract class SvgConstraint
    {
        ...
        public virtual IEnumerable<string> SvgDefs => [];
        ...
        protected SvgConstraint() { }    // for Classify
        ...
        public static (string name, Type type)[] Constraints => _constraintsCache ??= typeof(SvgConstraint).Assembly.GetTypes()
            .Where(t => typeof(SvgConstraint).IsAssignableFrom(t) && !t.IsAbstract && t.GetCustomAttribute<SvgConstraintInfoAttribute>() != null)
