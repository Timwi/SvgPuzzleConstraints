...
namespace SvgPuzzleConstraints
{
    ...
    public class NumberedRoom : SvgRowColNumberConstraint
    {
        ...
        public override double ExtraLeft => !IsCol && !Reverse ? .25 : 0;
        ...
        protected override string ElaborateSvg => $"""
            <g transform='translate({(IsCol ? RowCol + .5 : Reverse ? 9.35 : -.35)}, {(IsCol ? (Reverse ? 9.42 : -.42) : RowCol + .5)}) scale(.006) translate(-64, -64)'>
                ...
                <text x='64' y='55' font-size='45' stroke='black' fill='white' stroke-width='4' paint-order='stroke''>{Clue}</text>
            </g>
            """;
