...
{
    [SvgConstraintInfo("Double neighbors")]
    public class DoubleNeighbors : SvgNeighborConstraint
    {
        ...
        public static IList<SvgConstraint> Generate(int[] sudoku) => generate(sudoku, myVerify, (cell1, cell2) => new DoubleNeighbors(cell1, cell2));
    }
}
